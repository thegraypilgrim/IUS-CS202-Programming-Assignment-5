...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
        ...
        /** Returns true if the element is in the tree */
        public boolean search(E e, long[] count) {
                TreeNode<E> current = root; // Start from the root
                while (current != null) {
                        count[0]++;
                        if (e.compareTo(current.element) < 0) {
        ...
        protected ArrayList<E> path(E e, ArrayList<E> thePath, TreeNode<E> node){
                if(e.equals(node.element)){
                        thePath.add(node.element);
                        return thePath;
                }
                ...
                if(e.compareTo(node.element) < 0){
                        thePath.add(node.element);
                        path(e, thePath, node.left);
                        return thePath;
                }
                if(e.compareTo(node.element) > 0){
                        thePath.add(node.element);
                        path(e, thePath, node.right);
                        return thePath;
                }
                thePath.clear();
                return thePath;
        ...
        // returns an ArrayList of the preorder output
        protected ArrayList<E> preorderArray(TreeNode<E> node){
                ArrayList<E> list = new ArrayList<>();
                preorderArray(node, list);
                return list;
        }
        protected ArrayList<E> preorderArray(TreeNode<E> node, ArrayList<E> list){
                if(node ==  null){ 
                        return list;
                }
        ...
        public ArrayList<E> leftSubTree(E e){
                ...
                if(search(e)){
                        ...
                        return preorderArray(current.left);        
                }
                ArrayList<E> list = new ArrayList<>();
                return list;
        }
        ...
        public ArrayList<E> rightSubTree(E e){
                ...
                if(search(e)){
                        ...
                        return preorderArray(current.right);        
                }
                ArrayList<E> list = new ArrayList<>();
                return list;
        }
        ...
        private boolean sameTree(TreeNode<E> tree1, TreeNode<E> tree2){
                ...
                if(tree1.element.equals(tree2.element)){
